        ...
        <div class="mt-4 mx-4">
            <div class="flex justify-between">
                ...
                <Link
                    ...
                    class="bg-blue-500 text-white p-3 mb-4"
                    >Add Product</Link
                >
            </div>
            <table class="w-full bg-white border border-gray-200 shadow">
                <thead>
                    <tr>
                        <th class="py-2 px-2 text-left border">Id</th>
                        <th class="py-2 px-2 text-left border">Name</th>
                        <th class="py-2 px-2 text-left border">Price</th>
                        <th class="py-2 px-2 text-left border">Action</th>
                    </tr>
                </thead>
                <tbody>
